    ...
    <div
        ...
        <div
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-400 text-sm">Enter your credentials to access your workspace.</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <label
                        class="flex items-center text-sm text-gray-400 hover:text-white transition-colors cursor-pointer group">
                        <input type="checkbox" name="remember"
                            class="w-4 h-4 rounded bg-black/40 border-[#333] text-[#00D4FF] focus:ring-[#00D4FF] focus:ring-offset-0 transition-all">
                        <span class="ml-2 group-hover:text-gray-200 transition-colors">Remember me</span>
                    </label>
                    <a href="{{ route('password.request') }}"
                        class="text-sm text-[#00D4FF] hover:text-[#64FDDA] transition-colors font-medium">Forgot
                        password?</a>
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-400 text-sm">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-[#00D4FF] font-semibold hover:text-white transition-colors ml-1">Create one now</a>
                </p>
            </div>
        </div>
    </div>
